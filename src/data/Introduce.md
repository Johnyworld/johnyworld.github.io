...
- 의사소통은 슬랙 등 비동기 커뮤니케이션(슬랙 등)을 먼저 필수로 하고 필요한 경우 구두 소통을 추가로 합니다. 정말 급할 때에는 구두 소통을 먼저 하게 되는 경우도 있는데 반드시 구두로 소통했던 내용을 관련 문서나 쓰레드에 남기는 편입니다.
...
<div class="cv-profile"><img src="https://johnyworld2019.s3.ap-northeast-2.amazonaws.com/images/resume/me-1.png" alt="김재환 프로필 사진" /></div>